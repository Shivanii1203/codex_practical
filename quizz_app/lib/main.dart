...
class _MyHomePageState extends State<MyHomePage> {
    ...
    if (selectedIndex != -1) {
      if (buttonIndex == selectedIndex) {
        if (selectedIndex == questions[questionIndex]["correctOption"]) {
          totalScore++;
          return const MaterialStatePropertyAll(Color.fromARGB(255, 60, 188, 64));
        } else {
          return const MaterialStatePropertyAll(Color.fromARGB(255, 236, 29, 14));
        }
      } else {
        if (buttonIndex == questions[questionIndex]["correctOption"]) {
          return const MaterialStatePropertyAll(Color.fromARGB(255, 33, 224, 40));
        }
      }
    } else {
      return const MaterialStatePropertyAll(Color.fromARGB(255, 14, 167, 243));
    }
    return const MaterialStatePropertyAll(Color.fromARGB(255, 23, 172, 247));
  }

  Widget scoreBoard() {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(186, 30, 224, 217),
        title:
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor: MaterialStatePropertyAll(const Color.fromARGB(255, 17, 235, 213))),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(185, 225, 124, 178),
        title: Text("Quiz App ",
